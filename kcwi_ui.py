...
##### Adding keywords to a list where the keyword has an extra letter/number added to the end if the
##### the keyword is used in a different server.  This allows the dictionary to have a distinction.
binary_keywords = []
for i in range(0,13):
...
##### Adds the server to the keyword uptime as it exist in every server
...
##### Creating a list of the server associated with the proper keyword
server = []
for i in allServers:
	server.append(i)
...
app.config.update({
    ...
    'routes_pathname_prefix': '/page-2',

    # the front-end will prefix this string to the requests
    # that are made to the proxy server
    'requests_pathname_prefix': '/page-2'
})


##### Init theme of the app (light vs. dark)
theme = {
		'dark': False,
		'detail': '#007439',
		'primary': '#00EA64',
