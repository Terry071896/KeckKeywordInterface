...
serversRoot2 = html.Div([
    html.Div(id='nirspec-servers-container', className='indicator-box', children=[
        html.H4('Servers'),
        html.Div(id='nirspec-servers-1', className='indicator-box-no-border', children=[
            daq.Indicator(
                id='nspec-check',
                value=True,
                color='blue',
        ...
        html.Div(id='nirspec-servers-2', className='indicator-box-no-border', children=[
            daq.Indicator(
                id='nsmotor-check',
                value=True,
                color='blue',
    ...
    html.Div(id='nirspec-computer-container', className='indicator-box', children=[
        html.H4('Computers'),
        html.Div(className='indicator-box-no-border', children=[
            daq.Indicator(
...
powerRoot2 = html.Div([
    html.Div(id='nirspec-power-container', className='indicator-box', children=[
        ...
        html.Div(id='nirspec-power-container1', className='indicator-box-no-border', children=[
            daq.Indicator(
        ...
        html.Div(id='nirspec-power-container2', className='indicator-box-no-border', children=[
            daq.Indicator(
        ...
        html.Div(id='nirspec-power-container3', className='indicator-box-no-border', children=[
            daq.Indicator(
        ...
        html.Div(id='nirspec-power-container4', className='indicator-box-no-border', children=[
            daq.Indicator(
...
temperatureRoot2 = html.Div([
    html.Div(className='indicator-box', id='nirspec-detector-container', children=[
        ...
        html.Div(id='nirspec-detector1', className='indicator-box-no-border', children=[
            daq.Indicator(
        ...
        html.Div(id='nirspec-detector2', className='indicator-box-no-border', children=[
            daq.Indicator(
    ...
    html.Div(className='indicator-box', id='nirspec-dewar-container', children=[
        ...
        html.Div(id='nirspec-dewar1', className='indicator-box-no-border', children=[
            daq.Indicator(
        ...
        html.Div(id='nirspec-dewar2', className='indicator-box-no-border', children=[
            daq.Indicator(
...
mechanismRoot2 = html.Div([
    html.Div(id='nirspec-mechanism-container', className='indicator-box', children=[
        ...
        html.Div(id='nirspec-mechanism1', className='indicator-box-no-border', children=[
            daq.Indicator(
        ...
        html.Div(id='nirspec-mechanism2', className='indicator-box-no-border', children=[
            daq.Indicator(
...
layout = [
    dcc.Tabs(id="nirspec-tabs", value='nirspec-tabs', children=[
        dcc.Tab(id='nirspec-tab1', label='NIRSPEC Summary', value='nirspec-tabs1', className='custom-tab'+class_theme['dark'],
            ...
            html.Br(),
            daq.ToggleSwitch(
                id='nirspec-daq-light-dark-theme',
                label=['Light', 'Dark'],
                ...
                children=[
                    dcc.Tabs(id='nirspec-subtabs', value='subtabs1', children=[
                        ...
                        dcc.Tab(id='nirspec-subtab3', label='Mechanisms', value='subtab3', className='custom-tab'+class_theme['dark'],
                            selected_className='custom-tab--selected', children=daq.DarkThemeProvider(theme=theme, children=mechanismRoot2))
                    ])
                ]),
